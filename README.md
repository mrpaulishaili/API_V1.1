...
#### setting up Basic Routes and Middleware
...
- [Morgan Package](https://www.npmjs.com/package/morgan) for logging to the console

#### User Model

- [xx] create models folder and User.js file
...
- [x] imageURL: {type:String}
- [x] category: {type:Array}
